...
export default async function LessonEditPage({
  ...
  if (process.env.NEXT_PUBLIC_CONVEX_URL) {
    ...
    if (!token) {
      redirect(withLocale(locale, `/sign-in?next=/${locale}/app/courses/${courseSlug}/lessons/${lessonSlug}/edit`));
    }
  ...
  if (!liveLesson?.isAdmin) {
    redirect(withLocale(locale, `/app/courses/${courseSlug}/lessons/${lessonSlug}`));
  }
