...
export default function MessagesError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="grid min-h-[60vh] place-items-center p-4">
      <section role="alert" className="w-full max-w-lg rounded-[16px] border-2 border-ink bg-paper-strong p-6 text-center shadow-[6px_6px_0_0_var(--yellow)]">
        ...
        <h1 className="mt-4 type-h1 text-ink">{english ? "Messages could not be loaded" : "Poruke nisu učitane"}</h1>
