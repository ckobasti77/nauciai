...
export default function MessagesError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="grid min-h-[60vh] place-items-center p-4">
      <section role="alert" className="w-full max-w-lg rounded-[16px] border-2 border-ink bg-white p-7 text-center shadow-[6px_6px_0_0_#f4be30]">
        <span className="mx-auto grid size-14 place-items-center rounded-full border-2 border-ink bg-[#d7e9f5]">
