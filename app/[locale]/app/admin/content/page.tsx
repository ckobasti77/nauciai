...
import { AdminContentPanel } from "@/components/app/admin-content-manager";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return appPageMetadata(locale, { sr: "Sadržaj", en: "Content" });
}
...
export default async function AdminContentPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <AdminContentPanel locale={locale} />;
}
