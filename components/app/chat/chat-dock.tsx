  ...
  return (
    <div ref={motionRootRef} className="pointer-events-none fixed inset-0 z-[80] hidden lg:block" aria-live="polite" data-chat-motion-scope="dock">
      {visibleIds.map((conversationId, index) => (
        <div key={conversationId} data-chat-motion="dock" data-chat-motion-new="true" className="pointer-events-auto absolute bottom-5 h-[min(520px,calc(100vh-40px))] w-[330px] overflow-hidden rounded-[16px] border-2 border-ink bg-paper-strong shadow-[8px_8px_0_0_var(--shadow-hard)]" style={{ right: 84 + index * 342 }}>
