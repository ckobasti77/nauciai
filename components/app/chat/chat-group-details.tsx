...
export function ConversationDetailsDialog({
  ...
  return (
    <div className="fixed inset-0 z-[105] flex justify-end p-0 sm:p-3">
      <button type="button" tabIndex={-1} onClick={onClose} aria-label={label(locale, "Zatvori detalje razgovora", "Close conversation details")} className="absolute inset-0 rounded-none border-0 bg-ink/55 p-0 backdrop-blur-[2px]" />
