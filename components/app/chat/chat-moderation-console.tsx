...
function AppealsPanel({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="rounded-[16px] border-2 border-ink bg-paper-strong p-4 sm:p-5">
