    ...
    <div className="fixed inset-0 z-[100] grid place-items-end p-0 sm:place-items-center sm:p-4">
      ...
      <div ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="new-conversation-title" tabIndex={-1} data-chat-motion-surface="sheet" className="relative flex max-h-[min(760px,92dvh)] w-full flex-col overflow-hidden rounded-t-[16px] border-[3px] border-ink bg-white shadow-[9px_9px_0_0_rgba(14,49,88,0.24)] sm:w-[min(560px,100%)] sm:rounded-[16px]">
        ...
        {step === 1 ? <div className="grid gap-3 p-4 sm:grid-cols-2">
          ...
          <button type="button" onClick={() => { setMode("group"); setStep(2); }} className="rounded-[16px] border-2 border-ink bg-[#d7e9f5] p-5 text-left transition hover:-translate-y-0.5 hover:bg-[#c9dfed] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink">
          ...
          <div className="border-b border-line p-4">
            <button type="button" onClick={() => setStep(1)} className="mb-3 inline-flex items-center gap-2 rounded-full border border-ink bg-white px-3 py-1.5 text-[10px] font-black"><ArrowLeft className="size-3.5" />{label(locale, "Promeni vrstu", "Change type")}</button>
