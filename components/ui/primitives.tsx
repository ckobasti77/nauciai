  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "group link-button items-center justify-center gap-2 rounded-full border-2 font-extrabold transition-all duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
