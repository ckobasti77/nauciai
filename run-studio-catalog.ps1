...
$Steps += @{
  Id = "S0"; Model = "opus"; Effort = "high"
  Title = "Dovrsi Z2: globalni plafon troska"
  Prompt = @'
...
$Steps += @{
  Id = "S1"; Model = "opus"; Effort = "max"
  Title = "Nova sema: models, paramSpec, priceRule, computeCostUsd"
  Prompt = @'
...
$Steps += @{
  Id = "S2"; Model = "opus"; Effort = "high"
  Title = "Google slike - Nano Banana 2 i Pro, sinhrono"
  Prompt = @'
