...
export const marketingContent = {
  sr: {
    ...
    marquee: {
      ...
      // isti `target`).
      items: [
        { label: "montiraš AI video", target: "va" },
        { label: "napraviš sajt bez kodiranja", target: "vc" },
        { label: "generišeš slike za Instagram", target: "studio" },
        { label: "kloniraš svoj glas", target: "va" },
        { label: "objaviš sajt za jedan dan", target: "vc" },
        { label: "pitaš kad zapneš", target: "community" },
        { label: "napišeš scenario za 5 minuta", target: "va" },
        { label: "napraviš online prodavnicu", target: "vc" },
        { label: "napraviš logo za brend", target: "studio" },
        { label: "sinhronizuješ video na engleski", target: "va" },
        { label: "dodaš formu za kontakt", target: "vc" },
        { label: "napraviš voiceover bez mikrofona", target: "va" },
        { label: "napraviš thumbnail koji se klikće", target: "studio" },
        { label: "povežeš domen sa sajtom", target: "vc" },
        { label: "izrežeš shorts iz dugog videa", target: "va" },
        { label: "pokažeš šta si napravio/la", target: "community" },
        { label: "pretvoriš skicu u sliku", target: "studio" },
        { label: "dodaš titlove jednim klikom", target: "va" },
        { label: "napraviš landing stranu za proizvod", target: "vc" },
        { label: "napraviš intro za YouTube kanal", target: "va" },
        { label: "napraviš vizuale za prezentaciju", target: "studio" },
        { label: "animiraš fotografiju", target: "va" },
        { label: "napraviš portfolio sajt", target: "vc" },
        { label: "očistiš zvuk snimka", target: "va" },
        { label: "ukloniš pozadinu sa fotografije", target: "studio" },
        { label: "učiš uz ljude koji pričaju srpski", target: "community" },
        { label: "napraviš aplikaciju za zakazivanje", target: "vc" },
        { label: "napraviš reklamu za svoj biznis", target: "va" },
        { label: "napraviš avatar za profil", target: "studio" },
        { label: "popraviš bag bez programera", target: "vc" },
        { label: "pretvoriš tekst u podkast", target: "va" },
        { label: "napraviš plakat za događaj", target: "studio" },
        { label: "napraviš svoj blog", target: "vc" },
        { label: "napraviš muziku za video", target: "va" },
        { label: "napraviš kratki video iz slike", target: "studio" },
        { label: "dobiješ odgovor od predavača", target: "community" },
        { label: "napraviš meni za restoran", target: "vc" },
        { label: "napraviš ilustracije za knjigu", target: "studio" },
        { label: "snimiš kurs bez kamere", target: "va" },
        { label: "napraviš stranicu za događaj", target: "vc" },
      ] as MarqueeItem[],
    },
    courses: {
